	...
	<div class="card-body">
		<form action="return.jsp" method="post">
			<div class="row">
				...
				<div class="col-md-5 mt-1">
					<div class="form-group">
						<label for="rdate" class="form-control" >Return Book Date:</label>
					</div>
				</div>
				<div class="col-md-7">	
					<div class="form-group">
					...
					<div class="form-group">
						<input type="submit" name="btn-return_book" value="Submit" class="btn btn-danger form-control  ">
					</div>
				</div>
		</form>
	</div>
...
<%
String btn=request.getParameter("btn-return_book");
...
if(btn==null){
    ...
    String returnbdate = request.getParameter("rdate");

    Class.forName("com.mysql.jdbc.Driver");
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/libraby_jsp","root","");
    Statement st = con.createStatement();
    //ResultSet rs;
 int i = st.executeUpdate("DELETE FROM `borrow` WHERE book_id='"+bookid+"'");
      if (i > 0) {
        //session.setAttribute("userid", user);
        out.print("<script>alert('Book Returned Succesfully')</script>");
      out.println("<script>window.location='return.jsp'</script>");
